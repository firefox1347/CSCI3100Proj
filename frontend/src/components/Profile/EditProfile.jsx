...
const originalName = authUser.username;
  ...
  const handleSubmit = (e) => {
    ...
    const profileData = Object.fromEntries(
      Object.entries(updatedData).filter(([key, value]) => value !== originalData[key])
    );
  ...
  return (
    ...
    >
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        ...
        />
        <span></span>
        <button type="submit" disabled={isLoading} className="btn btn-info flex flex-col w-full text-white bg-blue-600">

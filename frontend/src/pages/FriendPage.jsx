...
//   followinglist = currentUserFollows?.followingList || [];
  ...
  const recommendedUsersfds = currentUserFollowStatus?.followingList || [];

  console.log(recommendedUsersfds);
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
      ...
      <div className="col-span-1 lg:col-span-2 order-first lg:order-none">
        ...
        {allPosts?.posts
  .filter((post) => recommendedUsersfds.includes(post.author))
  .map((post) => (
